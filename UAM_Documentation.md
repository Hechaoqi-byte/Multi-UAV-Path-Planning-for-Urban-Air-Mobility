...
![Tab 1  Performance Comparative Analysis of Five Path Planning Algorithms](./Testing & Verification/Image/Tab 1  Performance Comparative Analysis of Five Path Planning Algorithms.png)

![Fig 1. Path planning results of the five algorithms for the same start and end points.](./Testing & Verification/Image/Fig 1. Path planning results of the five algorithms for the same start and end points..png)
...
![Fig 2. MTSP Task Planning Results for a Scenario with 16 UAVs and 15 Tasks](./Testing & Verification/Image/Fig 2. MTSP Task Planning Results for a Scenario with 16 UAVs and 15 Tasks.png)

*Fig 2. MTSP Task Planning Results for a Scenario with 16 UAVs and 15 Tasks*

![Fig 3. MTSP Task Planning Results for a Scenario with 9 UAVs and 9 Tasks](./Testing & Verification/Image/Fig 3. MTSP Task Planning Results for a Scenario with 9 UAVs and 9 Tasks.png)
...
![Fig 4. Comparison of Original BiRRT and Optimized Trajectories Across X, Y, and Z Axes](./Testing & Verification/Image/Fig 4. Comparison of Original BiRRT and Optimized Trajectories Across X, Y, and Z Axes.png)
...
![Fig 5. Functional Block Diagram of the System](./Testing & Verification/Image/Fig 5. Functional Block Diagram of the System.png)
...
![Fig 6. Global BiRRT Planned Piecewise Linear Path for 15 Tasks and 16 UAVs](./Testing & Verification/Image/Fig 6. Global BiRRT Planned Piecewise Linear Path for 15 Tasks and 16 UAVs.png)
...
![Fig 7. A Minimum-Snap Smoothed Global Reference Path for 15 Tasks and 16 UAVs](./Testing & Verification/Image/Fig 7. A Minimum-Snap Smoothed Global Reference Path for 15 Tasks and 16 UAVs.png)
...
![Fig 8. Reference vs Actual Trajectories in the case of 15 task points and 16 UAVs — Length Statistics](./Testing & Verification/Image/Fig 8. Reference vs Actual Trajectories in the case of 15 task points and 16 UAVs — Length Statistics.png)
...
![Fig 9. Reference and Actual Trajectories for 15 Tasks and 16 UAVs](./Testing & Verification/Image/Fig 9. Reference and Actual Trajectories for 15 Tasks and 16 UAVs.png)
...
![Fig 10. Reference and Actual UAV Trajectories in OccupancyMap3D (15 Tasks, 16 UAVs)](./Testing & Verification/Image/Fig 10. Reference and Actual UAV Trajectories in OccupancyMap3D (15 Tasks, 16 UAVs).png)
...
- Animation 1: All UAVs executing 15 tasks with 16 UAVs in total.
  ...
  <video src="./Testing &amp; Verification/Video/video 1  All UAVs executing 15 tasks with 16 UAVs in total..mp4"></video>

- Animation 2: Single UAV (UAV 5) performing its assigned task in the case of 15 task points and 16 UAVs.

  <video src="./Testing &amp; Verification/Video/video 2 Single UAV (UAV 5) performing its assigned task in the case of 15 task points and 16 UAVs..mp4"></video>

- Animation 3: Single UAV (UAV 9) performing its assigned task in the case of 15 task points and 16 UAVs.

  <video src="./Testing &amp; Verification/Video/video 3 Single UAV (UAV 9) performing its assigned task in the case of 15 task points and 16 UAVs..mp4"></video>

- Animation 4: Single UAV (UAV 11) performing its assigned task in the case of 15 task points and 16 UAVs.

  <video src="./Testing &amp; Verification/Video/video 4 Single UAV (UAV 11) performing its assigned task in the case of 15 task points and 16 UAVs..mp4"></video>
...
![Fig 11. Reference vs Actual Trajectories in the case of 9 task points and 9 UAVs — Length Statistics](./Testing & Verification/Image/Fig 11. Reference vs Actual Trajectories in the case of 9 task points and 9 UAVs — Length Statistics.png)

*Fig 11. Reference vs Actual Trajectories — Length Statistics*

**Visualization of Reference and Actual Trajectories:** (The reference trajectories are shown as dashed lines, and the actual UAV trajectories as solid lines.)

![Fig 12. Reference and Actual Trajectories for 9 Tasks and 9 UAVs](./Testing & Verification/Image/Fig 12. Reference and Actual Trajectories for 9 Tasks and 9 UAVs.png)

*Fig 12. Reference and Actual Trajectories for 9 Tasks and 9 UAVs*

**Display of Reference and Actual Trajectories in the Manhattan OccupancyMap3D Scene:**

![Fig 13. Reference and Actual UAV Trajectories in OccupancyMap3D (9 Tasks, 9 UAVs)](./Testing & Verification/Image/Fig 13. Reference and Actual UAV Trajectories in OccupancyMap3D (9 Tasks, 9 UAVs).png)
...
![Figure 14. Avoidance after Collision Detection — 3D Trajectory View (0° Intersection)](./Testing & Verification/Image/Figure 14. Avoidance after Collision Detection — 3D Trajectory View (0° Intersection).png)

*Figure 14. Avoidance after Collision Detection — 3D Trajectory View (0° Intersection)*

![Figure 15. Avoidance after Collision Detection — XY-Plane View (0° Intersection)](./Testing & Verification/Image/Figure 15. Avoidance after Collision Detection — XY-Plane View (0° Intersection).png)

*Figure 15. Avoidance after Collision Detection — XY-Plane View (0° Intersection)*

![Figure 16. Distance Between Two UAVs vs. Time (0° Intersection)](./Testing & Verification/Image/Figure 16. Distance Between Two UAVs vs. Time (0° Intersection).png)

*Figure 16. Distance Between Two UAVs vs. Time (0° Intersection)*

**(2) Oblique Crossing (Trajectory Intersection Angle = 30°)**

![Figure 17. Avoidance after Collision Detection — 3D Trajectory View (30° Intersection)](./Testing & Verification/Image/Figure 17. Avoidance after Collision Detection — 3D Trajectory View (30° Intersection).png)

*Figure 17. Avoidance after Collision Detection — 3D Trajectory View (30° Intersection)*

![Figure 18. Avoidance after Collision Detection — XY-Plane View (30° Intersection)](./Testing & Verification/Image/Figure 18. Avoidance after Collision Detection — XY-Plane View (30° Intersection).png)

*Figure 18. Avoidance after Collision Detection — XY-Plane View (30° Intersection)*

![Figure 19. Distance Between Two UAVs vs. Time (30° Intersection)](./Testing & Verification/Image/Figure 19. Distance Between Two UAVs vs. Time (30° Intersection).png)

*Figure 19. Distance Between Two UAVs vs. Time (30° Intersection)*

**(3) Perpendicular Crossing (Trajectory Intersection Angle = 90°)**

![Figure 20. Avoidance after Collision Detection — 3D Trajectory View (90° Intersection)](./Testing & Verification/Image/Figure 20. Avoidance after Collision Detection — 3D Trajectory View (90° Intersection).png)

*Figure 20. Avoidance after Collision Detection — 3D Trajectory View (90° Intersection)*

![Figure 21. Avoidance after Collision Detection — XY-Plane View (90° Intersection)](./Testing & Verification/Image/Figure 21. Avoidance after Collision Detection — XY-Plane View (90° Intersection).png)

*Figure 21. Avoidance after Collision Detection — XY-Plane View (90° Intersection)*

![Figure 22. Distance Between Two UAVs vs. Time (90° Intersection)](./Testing & Verification/Image/Figure 22. Distance Between Two UAVs vs. Time (90° Intersection).png)
