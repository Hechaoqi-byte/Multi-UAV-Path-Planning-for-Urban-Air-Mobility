%% ============================================================
%% UAV Collision Avoidance - Crossing Scenario 90° (Sensor + MPC)
%% ============================================================
% Features:
...
fprintf('=== UAV Collision Avoidance (Crossing 90° Scenario) ===\n\n');
rng(42);
...
CONFIG.acc_max = 8;
CONFIG.safety_margin = 2;           % Safety distance: 2m
...
%% 3. Create UAV Platforms (Crossing configuration - 90 degree intersection)
% UAV1: West to East (horizontal)
% UAV2: South to North (vertical)
% Intersection point at (0, 0)
uav_start = [
    -70,   0, CONFIG.flight_altitude;   % UAV1: horizontal path
      0, -70, CONFIG.flight_altitude;   % UAV2: vertical path
];
uav_target = [
     70,   0, CONFIG.flight_altitude;   % UAV1: horizontal path
      0,  70, CONFIG.flight_altitude;   % UAV2: vertical path
...
title(sprintf('Crossing 90° Scenario - Top View (Min Distance: %.2fm)', minDist), 'FontSize', 14);
legend('Location', 'bestoutside', 'FontSize', 10);
xlim([-90, 90]); ylim([-90, 90]);
saveas(fig1, 'crossing90_topview.png');
fprintf('Saved: crossing90_topview.png\n');
...
title(sprintf('Crossing 90° Scenario - 3D Trajectory (Min Distance: %.2fm)', minDist), 'FontSize', 14);
legend('Location', 'bestoutside', 'FontSize', 10);
view(45, 30);
saveas(fig2, 'crossing90_3d.png');
fprintf('Saved: crossing90_3d.png\n');
...
title('Crossing 90° Scenario - UAV Separation Distance', 'FontSize', 14);
legend('Location', 'best', 'FontSize', 11);
xlim([0, max(timeVec)+1]);
saveas(fig3, 'crossing90_distance.png');
fprintf('Saved: crossing90_distance.png\n');
