%% ============================================================
%% UAV Collision Avoidance - Head-on Scenario (Sensor + MPC)
%% ============================================================
% Features:
...
fprintf('=== UAV Collision Avoidance (Head-on Scenario) ===\n\n');
rng(42);
...
%% 3. Create UAV Platforms (Head-on configuration)
uav_start = [
    -70, -50, CONFIG.flight_altitude;
     70,  50, CONFIG.flight_altitude;
];
uav_target = [
     70,  50, CONFIG.flight_altitude;
...
for u = 1:CONFIG.numUAVs
    ...
    % Initialize MPC planner structure
    planners{u} = struct();
...
title(sprintf('Head-on Scenario - Top View (Min Distance: %.2fm)', minDist), 'FontSize', 14);
legend('Location', 'bestoutside', 'FontSize', 10);
xlim([-90, 90]); ylim([-80, 80]);
saveas(fig1, 'headon_topview.png');
fprintf('Saved: headon_topview.png\n');
...
title(sprintf('Head-on Scenario - 3D Trajectory (Min Distance: %.2fm)', minDist), 'FontSize', 14);
legend('Location', 'bestoutside', 'FontSize', 10);
view(45, 30);
saveas(fig2, 'headon_3d.png');
fprintf('Saved: headon_3d.png\n');
...
title('Head-on Scenario - UAV Separation Distance', 'FontSize', 14);
legend('Location', 'best', 'FontSize', 11);
xlim([0, max(timeVec)+1]);
saveas(fig3, 'headon_distance.png');
fprintf('Saved: headon_distance.png\n');
